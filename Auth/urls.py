...
router.register(r'interest', views.MyInterestViewSet, base_name='interest')
...
router.register(r'recommended', views.UserListViewSet, base_name='get_recomended_users')
