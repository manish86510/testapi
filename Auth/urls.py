...
router.register(r'user/education', views.EducationViewSet, base_name='education')
router.register(r'user/follower', views.FollowerViewSet, base_name='follower')
router.register(r'user/interest', views.InterestViewSet, base_name='interest')
router.register(r'user/language', views.LanguageViewSet, base_name='language')
router.register(r'user/places', views.PlaceViewSet, base_name='places')
router.register(r'user/projects', views.ProjectViewSet, base_name='projects')
router.register(r'user/skill', views.SkillViewSet, base_name='skill')
